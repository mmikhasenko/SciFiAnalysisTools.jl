...
shape_p5pz6 = readdlm(joinpath("..", "data", "p5pz6_shaperputput.csv")) |> normalized_set;

# ╔═╡ 1f155077-f155-45f1-9c85-b2f1ec94be76
shape_p5pz5 = readdlm(joinpath("..", "data", "p5pz5_shaperputput.csv")) |> normalized_set;
...
sipm0 = SiPM(3.5, 2, 0.2; n_τ_long = 1.02, c_long = 0.8)
